...
public interface ProductSpecificationCommandApiSpecification {
    ...
    ResponseEntity<Void> create(SpecificationCreateRequest request);
    ...
    ResponseEntity<Void> changeInformation(SpecificationChangeInformationRequest request);
    ...
    ResponseEntity<Void> delete(SpecificationDeleteRequest request);
    ...
    ResponseEntity<Void> assignCategory(SpecificationAssignCategoryRequest request);
    ...
    ResponseEntity<Void> removeCategoryAssignment(SpecificationRemoveCategoryAssignmentRequest request);
}
