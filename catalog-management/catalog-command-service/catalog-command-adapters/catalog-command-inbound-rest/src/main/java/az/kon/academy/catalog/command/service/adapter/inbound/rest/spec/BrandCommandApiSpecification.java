...
public interface BrandCommandApiSpecification {
    ...
    ResponseEntity<BrandCreateCommandResult> createGlobal(BrandCreateGlobalRequest request);
    ...
    ResponseEntity<BrandCreateCommandResult> createMerchant(BrandCreateForMerchantRequest request);
