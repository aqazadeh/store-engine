...
public interface VariantCommandApiSpecification {
    ...
    ResponseEntity<Void> createKey(VariantKeyCreateRequest request);
    ...
    ResponseEntity<Void> changeKeyName(VariantKeyChangeNameRequest request);
    ...
    ResponseEntity<Void> changeKeyDescription(VariantKeyChangeDescriptionRequest request);
    ...
    ResponseEntity<Void> createValue(VariantValueCreateRequest request);
    ...
    ResponseEntity<Void> changeValueName(VariantValueChangeNameRequest request);
}
