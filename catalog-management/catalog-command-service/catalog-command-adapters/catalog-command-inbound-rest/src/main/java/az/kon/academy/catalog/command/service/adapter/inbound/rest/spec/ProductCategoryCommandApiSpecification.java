...
public interface ProductCategoryCommandApiSpecification {
    ...
    ResponseEntity<Void> createProductCategory(@Valid @RequestBody ProductCategoryCreateRequest request);
    ...
    ResponseEntity<Void> updateProductCategory(@Valid @RequestBody ProductCategoryActivateRequest request);
    ...
    ResponseEntity<Void> archiveProductCategory(@Valid @RequestBody ProductCategoryArchiveRequest request);
    ...
    ResponseEntity<Void> changeProductCategoryImage(@Valid @RequestBody ProductCategoryChangeImageRequest request);
    ...
    ResponseEntity<Void> changeProductCategoryInformation(@Valid @RequestBody ProductCategoryChangeInformationRequest request);
    ...
    ResponseEntity<Void> changeProductCategoryParent(@Valid @RequestBody ProductCategoryChangeParentRequest request);
}