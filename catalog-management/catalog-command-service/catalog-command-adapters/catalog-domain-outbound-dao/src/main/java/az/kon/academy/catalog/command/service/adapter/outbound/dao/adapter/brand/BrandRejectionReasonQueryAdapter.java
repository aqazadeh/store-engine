...
@QueryAdapter
public class BrandRejectionReasonQueryAdapter implements BrandRejectionReasonQueryPort {

    private final DSLContext dsl;
    private final BrandRejectionReasonMapper mapper;

    public BrandRejectionReasonQueryAdapter(DSLContext dsl, BrandRejectionReasonMapper mapper) {
        this.dsl = dsl;
        this.mapper = mapper;
    }
