...
public class ProductAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6300701153629276515L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ProductAvroModel\",\"namespace\":\"az.kon.academy.catalog.avro.model.product\",\"fields\":[]}");
   ...
   */
  public static az.kon.academy.catalog.avro.model.product.ProductAvroModel.Builder newBuilder() {
    return new az.kon.academy.catalog.avro.model.product.ProductAvroModel.Builder();
  }
   ...
   * @return A new ProductAvroModel RecordBuilder
   */
  public static az.kon.academy.catalog.avro.model.product.ProductAvroModel.Builder newBuilder(az.kon.academy.catalog.avro.model.product.ProductAvroModel.Builder other) {
    if (other == null) {
      return new az.kon.academy.catalog.avro.model.product.ProductAvroModel.Builder();
    } else {
      return new az.kon.academy.catalog.avro.model.product.ProductAvroModel.Builder(other);
    }
  }
   ...
   * @return A new ProductAvroModel RecordBuilder
   */
  public static az.kon.academy.catalog.avro.model.product.ProductAvroModel.Builder newBuilder(az.kon.academy.catalog.avro.model.product.ProductAvroModel other) {
    if (other == null) {
      return new az.kon.academy.catalog.avro.model.product.ProductAvroModel.Builder();
    } else {
      return new az.kon.academy.catalog.avro.model.product.ProductAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ProductAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(az.kon.academy.catalog.avro.model.product.ProductAvroModel.Builder other) {
      super(other);
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(az.kon.academy.catalog.avro.model.product.ProductAvroModel other) {
      super(SCHEMA$, MODEL$);
    }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof ProductAvroModel)) {
      return false;
    }
    ProductAvroModel other = (ProductAvroModel) o;
    return true;
  }
}
