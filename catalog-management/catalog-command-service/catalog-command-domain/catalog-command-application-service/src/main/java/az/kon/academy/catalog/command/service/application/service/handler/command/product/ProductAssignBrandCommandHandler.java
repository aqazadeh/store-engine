...
@CommandHandler(
        ...
        permissions = SecurityPermissions.Product.PRODUCT_ASSIGN_BRAND)
public class ProductAssignBrandCommandHandler implements AbstractCommandHandler<ProductAssignBrandCommand, Void> {

    private final SeDomainContext domainContext;
    private final DomainEventPublisher domainEventPublisher;
    private final ProductManagementDomainService productManagementDomainService;

    public ProductAssignBrandCommandHandler(SeDomainContext domainContext,
    ...
    public Void handle(ProductAssignBrandCommand command) {
        var aggregate = this.productManagementDomainService.assignBrand(domainContext, command);
