...
@CommandHandler(
        ...
        permissions = SecurityPermissions.ProductSpecification.PRODUCT_SPECIFICATION_ASSIGN_CATEGORY)
public class SpecificationAssignCategoryCommandHandler implements AbstractCommandHandler<SpecificationAssignCategoryCommand, Void> {

    private final SeDomainContext domainContext;
    private final DomainEventPublisher domainEventPublisher;
    private final ProductSpecificationDomainService productSpecificationDomainService;

    public SpecificationAssignCategoryCommandHandler(SeDomainContext domainContext,
