...
import static az.kon.academy.catalog.command.service.application.service.constant.SecurityPermissions.ProductSpecification.PRODUCT_SPECIFICATION_MODERATION_REMOVE_CATEGORY_ASSIGNMENT;
...
@CommandHandler(roles = ROLE_DOMAIN_MODERATOR, permissions = PRODUCT_SPECIFICATION_MODERATION_REMOVE_CATEGORY_ASSIGNMENT)
public class ProductSpecificationRemoveCategoryAssignmentCommandHandler implements AbstractCommandHandler<ProductSpecificationRemoveCategoryAssignmentCommand, Void> {

    private final SeDomainContext domainContext;
    private final DomainEventPublisher domainEventPublisher;
    private final ProductSpecificationModerationDomainService productSpecificationModerationDomainService;

    public ProductSpecificationRemoveCategoryAssignmentCommandHandler(SeDomainContext domainContext,
    ...
    @Override
    public Void handle(ProductSpecificationRemoveCategoryAssignmentCommand command) {
        var productSpecification = this.productSpecificationModerationDomainService.removeCategoryAssignment(domainContext, command);
