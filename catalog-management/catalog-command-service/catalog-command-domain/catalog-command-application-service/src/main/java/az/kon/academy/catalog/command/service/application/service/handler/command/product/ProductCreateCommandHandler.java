...
@CommandHandler(
        ...
        permissions = SecurityPermissions.Product.PRODUCT_CREATE)
public class ProductCreateCommandHandler implements AbstractCommandHandler<ProductCreateCommand, Void> {
