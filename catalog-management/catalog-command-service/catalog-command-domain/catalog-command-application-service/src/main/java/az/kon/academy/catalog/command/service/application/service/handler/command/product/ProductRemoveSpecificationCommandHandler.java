...
@CommandHandler(
        ...
        permissions = SecurityPermissions.Product.PRODUCT_REMOVE_SPECIFICATION)
public class ProductRemoveSpecificationCommandHandler implements AbstractCommandHandler<ProductRemoveSpecificationCommand, Void> {

    private final SeDomainContext domainContext;
    private final DomainEventPublisher domainEventPublisher;
    private final ProductManagementDomainService productManagementDomainService;

    public ProductRemoveSpecificationCommandHandler(SeDomainContext domainContext,
    ...
    @Override
    public Void handle(ProductRemoveSpecificationCommand command) {
        var aggregate = this.productManagementDomainService.removeSpecification(domainContext, command);
