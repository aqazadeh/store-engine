...
@InputAdapter
class SpecificationRestAdapter implements SpecificationRestPort {
    ...
    public SpecificationRestAdapter(SpecificationCreateCommandHandler specificationCreateCommandHandler,
