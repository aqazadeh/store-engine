...
import static az.kon.academy.catalog.command.service.application.service.constant.SecurityPermissions.Brand.BRAND_MODERATION_MARK_IN_REVIEW;
...
@CommandHandler(roles = ROLE_DOMAIN_MODERATOR, permissions = BRAND_MODERATION_MARK_IN_REVIEW)
public class BrandMoveToInReviewCommandHandler implements AbstractCommandHandler<BrandMoveToInReviewCommand, Void> {

    private final SeDomainContext domainContext;
    private final DomainEventPublisher domainEventPublisher;
    private final BrandModerationDomainService brandModerationDomainService;

    public BrandMoveToInReviewCommandHandler(SeDomainContext domainContext,
    ...
    @Override
    public Void handle(BrandMoveToInReviewCommand command) {
        var brand = this.brandModerationDomainService.moveToInReview(domainContext, command);
