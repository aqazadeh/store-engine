...
@InputAdapter
class BrandManagementInboundAdapter implements BrandManagementInboundPort {
    ...
    public BrandManagementInboundAdapter(SeSecurityContextHolder securityContextHolder,
