...
@CommandHandler(
        ...
        permissions = SecurityPermissions.Variant.VARIANT_KEY_CHANGE_NAME)
public class VariantKeyChangeNameCommandHandler implements AbstractCommandHandler<VariantKeyChangeNameCommand, Void> {
    ...
    public Void handle(VariantKeyChangeNameCommand command) {
        var aggregate = this.productVariantModerationDomainService.changeKeyName(domainContext, command);
