...
import static az.kon.academy.catalog.command.service.application.service.constant.SecurityPermissions.Brand.BRAND_MANAGEMENT_MOVE_DRAFT;
import static az.kon.academy.catalog.command.service.application.service.constant.SecurityPermissions.Role.ROLE_MERCHANT;

@CommandHandler(roles = ROLE_MERCHANT, permissions = BRAND_MANAGEMENT_MOVE_DRAFT)
