...
import static az.kon.academy.catalog.command.service.application.service.constant.SecurityPermissions.Brand.BRAND_MANAGEMENT_CHANGE_INFORMATION;
import static az.kon.academy.catalog.command.service.application.service.constant.SecurityPermissions.Role.ROLE_MERCHANT;

@CommandHandler(roles = ROLE_MERCHANT, permissions = BRAND_MANAGEMENT_CHANGE_INFORMATION)
