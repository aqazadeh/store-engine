...
@InputAdapter
public class BrandModerationInboundAdapter implements BrandModerationInboundPort {
    ...
    public BrandModerationInboundAdapter(SeSecurityContextHolder securityContextHolder,
