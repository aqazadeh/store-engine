...
import static az.kon.academy.catalog.command.service.application.service.constant.SecurityPermissions.ProductCategory.PRODUCT_CATEGORY_MODERATION_DELETE;
...
@CommandHandler(roles = ROLE_DOMAIN_MODERATOR, permissions = PRODUCT_CATEGORY_MODERATION_DELETE)
public class ProductCategoryDeleteCommandHandler implements AbstractCommandHandler<ProductCategoryDeleteCommand, Void> {

    private final SeDomainContext domainContext;
    private final DomainEventPublisher domainEventPublisher;
    private final ProductCategoryModerationDomainService productCategoryModerationDomainService;

    public ProductCategoryDeleteCommandHandler(SeDomainContext domainContext,
    ...
    @Override
    public Void handle(ProductCategoryDeleteCommand command) {
        var productCategory = this.productCategoryModerationDomainService.delete(domainContext, command);
