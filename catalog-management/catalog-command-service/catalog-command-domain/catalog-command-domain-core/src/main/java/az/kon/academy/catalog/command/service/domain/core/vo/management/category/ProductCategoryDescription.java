...
public final class ProductCategoryDescription {
    ...
    public ProductCategoryDescription(String value) {
        ...
        if (normalized.length() < ProductCategoryDescription.MIN_LENGTH) {
            throw new ProductCategoryDomainException(ProductCategoryDomainErrorCodes.DESCRIPTION_TOO_SHORT);
        }

        if (normalized.length() > ProductCategoryDescription.MAX_LENGTH) {
    ...
    public boolean equals(Object o) {
        ...
        ProductCategoryDescription that = (ProductCategoryDescription) o;
